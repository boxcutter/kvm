...
variable "iso_checksum" {
  type    = string
  default = "file:https://cdn.amazonlinux.com/al2023/os-images/2023.7.20250331.0/kvm-arm64/SHA256SUMS"
}

variable "iso_url" {
  type    = string
  default = "https://cdn.amazonlinux.com/al2023/os-images/2023.7.20250331.0/kvm-arm64/al2023-kvm-2023.7.20250331.0-kernel-6.1-arm64.xfs.gpt.qcow2"
}
