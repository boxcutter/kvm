...
$ isoinfo -R -i \
    ubuntu-26.04-beta-desktop-amd64-autoinstall.iso -f | grep -i autoinstall
/autoinstall.yaml
```
...
virsh destroy ubuntu-desktop-2604
virsh undefine ubuntu-desktop-2604 --nvram --remove-all-storage
```

```
virsh snapshot-create-as \
  --domain ubuntu-desktop-2604 \
  --name clean \
  --description "Initial install"

virsh snapshot-list ubuntu-desktop-2604
virsh snapshot-revert ubuntu-desktop-2604 clean
virsh snapshot-delete ubuntu-desktop-2604 clean

virsh shutdown ubuntu-desktop-2604
virsh shutdown ubuntu-desktop-2604
```
